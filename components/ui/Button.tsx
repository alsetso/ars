...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, asChild, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-brand-primary text-white hover:bg-brand-primary-dark focus-visible:ring-brand-primary active:bg-brand-primary-dark',
      secondary: 'bg-brand-secondary text-white hover:bg-brand-secondary-dark focus-visible:ring-brand-secondary active:bg-brand-secondary-dark',
