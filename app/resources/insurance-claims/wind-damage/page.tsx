...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://advancedroofingmn.com/resources/insurance-claims/wind-damage',
  },
  openGraph: {
    title: 'Wind Damage Claims - Roof & Siding Experts | Minnesota & Wisconsin',
    ...
    url: 'https://advancedroofingmn.com/resources/insurance-claims/wind-damage',
    images: [
      {
...
export default function WindDamageClaimsPage() {
  return (
    <PageLayout>
      ...
      <ClaimSubNav current="/resources/insurance-claims/wind-damage" />
