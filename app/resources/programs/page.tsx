...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://advancedroofingmn.com/resources/programs',
  },
}
...
const programs = [
  {
    ...
    icon: Building2,
    href: '/resources/programs/municipal',
    features: [
  ...
  },
  {
    ...
    icon: Building2,
    href: '/resources/programs/property-manager',
    features: [
  ...
  },
  {
    ...
    icon: Home,
    href: '/resources/programs/residential',
    features: [
  ...
  },
  {
    ...
    icon: Briefcase,
    href: '/resources/programs/commercial',
    features: [
